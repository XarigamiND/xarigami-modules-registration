 ...
 * @param userdisplayname - the display name of the user (optional) - may not be set, or empty
...
function registration_userapi_notifyadmin ($args)
{
    ...
    if (!xarVarFetch('userdisplayname', 'str:1:', $userdisplayname, 'New User', XARVAR_NOT_REQUIRED, XARVAR_PREP_FOR_DISPLAY)) return;
    ...
    if ($requireapproval) {
        ...
        $messagetitle = xarML('A new user has registered: #(1) "#(2)"', $username, $userdisplayname);
    }
    ...
    $object = Dynamic_Object_Master::getObject(array('moduleid' => xarModGetIdFromName('roles'),'itemtype'=>2));
